...
Mark_node1704390766767 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths":["s3://de-demo-7/staging/mark/"],
        "recurse": True,
    },
...
Student_node1704390766920 = glueContext.create_dynamic_frame.from_options(
    ...
    format = "csv",
    connection_options={
        "paths": ["s3://de-demo-7/staging/student/"],
        "recurse": True,
    },
...
DW_node1704390869493 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths":["s3://de-demo-7/staging/warehouse/"],
        "recurse": True,
    },
...
AmazonS3_node1704390958322 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://de-demo-7/staging/warehouse/",
        "partitionKeys": [],
    },
